...
<li class="nav-item">
    <a class="nav-link" href="{{ backpack_url('custom') }}"><i class="la la-home nav-icon"></i> {{ trans('backpack::base.dashboard') }}</a>
</li>
<li class="nav-item nav-dropdown">
    <a class="nav-link nav-dropdown-toggle" href="{{ backpack_url('dashboard') }}"><i class="la la-pied-piper-alt nav-icon"></i> PROJECT CRUD </a>
